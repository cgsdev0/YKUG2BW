...
$timerightnow=time();
$idnumber=$_POST['id'];
$commentcontent=quote($_POST['comment']);
if(ctype_digit($idnumber)) {
mysql_query("INSERT INTO comments (uid, id, content, time) VALUES ($userid, $idnumber, $commentcontent, $timerightnow)");
$message="The comment was posted successfully.";
}
else {
